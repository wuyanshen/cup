<template>
  <div>
    ...
    <el-card>
      <!--新增-->
      <el-button type="primary" icon="el-icon-plus" size="mini" @click="menuAddDialog=true">新增</el-button>
      <!-- 表格区 -->
      <el-table size="mini" :data="tableData" border stripe row-key="id" :header-cell-style="{background:'#F2F6FC'}">
    ...
    <el-dialog :show-close="false" title="新增菜单" :visible.sync="menuAddDialog" width="50%" @close="menuAddClose">
      <el-form size="mini" label-width="80px" :model="menuForm" ref="menuForm">
        ...
        <el-form-item label="权限标识" v-if="menuForm.type==='1'">
      ...
      <span slot="footer" class="dialog-footer">
        <el-button size="mini" @click="menuAddDialog = false">取 消</el-button>
        <el-button size="mini" type="primary" @click="handleMenuAdd">确 定</el-button>
      </span>
    </el-dialog>
    ...
    <el-dialog :show-close="false" title="修改菜单" :visible.sync="menuEditDialog" width="50%" @close="menuEditClose">
      ...
      <span slot="footer" class="dialog-footer">
        <el-button size="mini" @click="menuEditDialog = false">取 消</el-button>
        <el-button size="mini" type="primary" @click="handleMenuUpdate">确 定</el-button>
      </span>
    </el-dialog>
  </div>
